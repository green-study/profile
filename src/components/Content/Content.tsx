...
const projects = [
    {
        ...
        contribution: ['TypeScript와 React 기반 Front-end UI 개발', 'Github Workflow를 통한 웹 배포'],
        hideLink1: false,
        buttonText1: '소스코드',
        hideLink2: false,
        buttonText2: '웹사이트'
    ...
    },
    {
        ...
        contribution: ['정적 분석을 통해 프로그램에 맟줘 JNI header 파일을 자동 제작하도록 구현', 'JNI header 파일이 Java와 C/C++ 간의 전송 정보 오류를 감지하도록 지원', 'LLVM 및 FlowDroid와 같은 정적 분석 도구를 활용'],
        hideLink1: false,
        buttonText1: '소스코드',
        hideLink2: false,
        buttonText2: '동영상'
    },
    {
        ...
        link2: '',
        contribution: ['무게 센서와 열화상 카메라를 통해 배변 활동을 감지하는 배변패드 제작', 'Raspberry Pi 4와 ESP32 간 Bluetooth 통신을 활용', 'ThingsBoard를 활용하여 사용자가 반려견의 배변 활동을 확인할 수 있는 IoT 기능 구현', '팀의 리더로 프로젝트 제작 및 논문 작성까지 전체적인 과정을 주도'],
        hideLink1: false,
        buttonText1: '동영상',
        hideLink2: true,
        buttonText2: ''
    ...
    },
    {
        ...
        contribution: ['Flutter를 사용하여 앱의 Front-end UI/UX 개발을 설계하고 구현','사용자 반응 테스트 및 Android Studio를 통한 디버깅으로 문제를 해결', '팀의 리더로 프로젝트를 이끌며 9개의 팀 중 1등상을 수상'],
        hideLink1: false,
        buttonText1: '동영상 1',
        hideLink2: false,
        buttonText2: '동영상 2'
    },
    {
        ...
        link2: '',
        contribution: ['인스타그램 해시태크, 네이버 실시간 검색어 웹 크롤링 데이터와 네이버 데이터랩 정보 분석','Pandas와 Matplotlib을 통해 분석 결과 시각화', '저학년 부분 1등상을 수상'],
        hideLink1: false,
        buttonText1: '동영상',
        hideLink2: true,
        buttonText2: ''
